...
from .views import ServiceByCategoryAPIView, ServiceCatalogAPIView, ServiceCreateAPIView, ServiceDetailAPIView, ServiceListAPIView, ServiceUpdateAPIView, ServiceDeleteAPIView
...
urlpatterns = [
    ...
    path('search/', ServiceCatalogAPIView.as_view(), name='service-catalog-by-category'),
